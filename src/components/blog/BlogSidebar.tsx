...
import { CATEGORIES, FEATURED_POST, RECENT_POSTS, categoryHref, type Category } from "@/lib/blog";

export default function BlogSidebar({ activeCategory }: { activeCategory?: Category }) {
  return (
    <aside className="flex flex-col lg:w-1/3">
      ...
      <div className="mb-[25px] bg-white p-[50px]">
        <Link href={FEATURED_POST.href} className="group relative block h-[188px] w-full overflow-hidden">
          <Image
              ...
              <Link
                ...
                className={
                  cat === activeCategory
                    ...
                    : "text-black transition-colors hover:text-brand-teal"
                }
              >
                {cat}
              </Link>
