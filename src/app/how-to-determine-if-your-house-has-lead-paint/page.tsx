...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Not sure if your house has lead paint? Learn to identify lead paint in your home, including common signs, testing methods, and when to seek professional advice.",
  path: "/how-to-determine-if-your-house-has-lead-paint/",
});
...
export default function LeadPaintPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "How to Determine if Your House Has Lead Paint", path: "/how-to-determine-if-your-house-has-lead-paint/" }]} />
      <JsonLd data={articleSchema({
          headline: "How to Determine if Your House Has Lead Paint",
          description: "Learn how to tell if your home has lead-based paint, why it's dangerous, how to test for it, and what to do if you find it.",
          path: "/how-to-determine-if-your-house-has-lead-paint",
          image: "/images/a-quiet-street-in-the-australian-country-town-of-pemberton.jpg",
