...
export default function KeepYourPropertyLookingFreshWithPriorityOneCoatingsPage() {
  return (
    <div id="top">
      <Header />
      <main>
            ...
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <article className="lg:w-2/3">
                <h1 className="font-heading text-[32px] font-bold leading-[1.2] text-brand-navy sm:text-[40px]">
                  Keep Your Property Looking Fresh with The Leading Painting Services in Sydney
                </h1>

                <p className="mt-4 text-[15px] text-black/60">April 27, 2023</p>
                ...
                <div className="prose-blog mt-8 max-w-none text-[16px] leading-[1.8] text-black/80">
                  <p>
                    Are you tired of staring at the same old walls and peeling paint in your home? Do you wish to
                    transform the appearance of your property? Look no further than{" "}
                    <Link href="/">Priority One Coatings</Link>, the leading painting and decorating company in
                    Sydney.
                  </p>

                  <p>
                    At <strong>Priority One Coatings</strong>, we offer various residential painting Sydney-wide
                    services, including interior and exterior painting, specialist painted finishes, textured
                    coatings, floor coatings, waterproofing, lead paint removal, wallpapering, rust protection, and
                    heritage painting.
                  </p>

                  <p>
                    Our painting services are designed to meet the needs of every homeowner. Whether you&rsquo;re
                    looking for a complete interior or exterior painting job or just want to freshen up a room with
                    our <Link href="/">Sydney painters</Link>, we&rsquo;ve got you covered. Our professional painting
                    contractors will work with you to choose the perfect colours and finishes to suit your taste and
                    style.
                  </p>

                  <p className="text-center font-heading text-[19px] font-bold leading-[1.5] text-brand-navy">
                    We finish our paint job, ensuring that your property looks exactly how you expect it to.
                  </p>

                  <p>
                    Whether selling, buying or transforming your Sydney home, or looking to give your exterior walls
                    a new coat of paint or restore your property&rsquo;s heritage charm, we have a team of Dulux
                    accredited painters to get the job done.
                  </p>

                  <p>
                    We understand that your home is your comfort zone, and that&rsquo;s why we maintain minimal mess
                    and disruption for all the work. We always value time very seriously. With our top-notch and
                    reasonable service, we can increase your property&rsquo;s lifespan.
                  </p>

                  <p>
                    Along with our <Link href="/residential-painters/">residential painting services</Link>, we
                    offer other painting and decorating services to clients throughout Sydney, NSW. From commercial
                    painting to strata painting, we have the necessary skills to handle any paint job, big or small.
                  </p>

                  <p>
                    We use only top-quality materials and paints to ensure that your home looks great for years to
                    come. In addition, we help to retain your property&rsquo;s market value with our service. We are
                    proud of the paint job we do and make sure that every project is completed to the highest level
                    of professionalism.
                  </p>

                  <p>
                    Our team of professional painters Sydney-wide is ready and waiting to transform your property
                    and give it the fresh new look you&rsquo;ve been dreaming of.
                  </p>

                  <p className="text-center font-heading text-[19px] font-bold leading-[1.5] text-brand-navy">
                    To arrange a consultation and begin your next painting project, <Link href="/contact-us/">contact us</Link> today.
                  </p>
                </div>
                ...
                <div className="mt-10 flex items-center gap-3 border-t border-black/10 pt-8">
                  ...
                  <ShareIcon
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(POST_URL)}&text=${encodeURIComponent("Keep Your Property Looking Fresh with The Leading Painting Services in Sydney")}`}
                    label="Share on X"
                  >
                  ...
                  <ShareIcon
                    href={`mailto:?subject=${encodeURIComponent("Keep Your Property Looking Fresh with The Leading Painting Services in Sydney")}&body=${encodeURIComponent(`Check out this article: ${POST_URL}`)}`}
