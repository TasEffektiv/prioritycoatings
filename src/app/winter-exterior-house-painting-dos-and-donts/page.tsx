...
export default function WinterExteriorHousePaintingDosAndDontsPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Winter Exterior Painting In Sydney: Essential Tips", path: "/winter-exterior-house-painting-dos-and-donts/" }]} />
      <JsonLd data={articleSchema({
          headline: "Winter Exterior Painting In Sydney: Essential Tips",
          ...
          image: "/images/residential-house-with-front-yard-in-snow.jpg",
          datePublished: "June 10, 2026",
        })} />
      <main>
