...
export const metadata: Metadata = buildMetadata({
  ...
  description: "For commercial & residential painting projects, call Dulux accredited painters in Northern Beaches. Fully insured painting services at reasonable rates. Contact now!",
  path: "/painters-northern-beaches/",
});
...
export default function PaintersNorthernBeachesPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Northern Beaches", path: "/painters-northern-beaches/" }]} />
      <JsonLd data={serviceSchema({
          name: "Painting Services in Northern Beaches",
          description:
            "Dulux accredited painters in Northern Beaches for commercial & residential painting projects, fully insured.",
          path: "/painters-northern-beaches",
          areaServed: "Northern Beaches, NSW",
        })} />
      <main>
