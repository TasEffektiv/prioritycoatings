...
export default function GetYourEpoxyFlooringDoneWithPriorityOneCoatingsPage() {
  return (
    <div id="top">
      <Header />
      <main>
            ...
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <article className="lg:w-2/3">
                <h1 className="font-heading text-[32px] font-bold leading-[1.2] text-brand-navy sm:text-[40px]">
                  Get Your Epoxy Flooring Done with Our Epoxy Floor Coating Experts in Sydney
                </h1>

                <p className="mt-4 text-[15px] text-black/60">May 11, 2023</p>

                <div className="relative mt-6 aspect-[16/9] w-full overflow-hidden">
                  <Image
                    src="https://www.prioritycoatings.com.au/wp-content/uploads/2023/05/epoxy-floor-coatings-1.jpg"
                ...
                <div className="prose-blog mt-8 max-w-none text-[16px] leading-[1.8] text-black/80">
                  <p>
                    If you want a non-slippery, glossy and durable floor in your home or business premises, you may
                    find the best solution with epoxy floor coating. With high demand, epoxy flooring has become the
                    first choice whether it is a residential, commercial or industrial space. It is an excellent
                    option for high-traffic zones. It can protect your food and beverage or chemical processing
                    industry floor from mould and mildew. These floors are also water-resistant and easy to clean.
                    In addition, it gives an aesthetic appeal with resin and hardener mix to the ground.
                  </p>

                  <p>
                    After deciding to renovate your property base with this stunning flooring, the first task is to
                    find epoxy coating experts in Sydney. You will definitely don&rsquo;t want to regret investing in
                    a novice service provider. In this case, <strong>Priority One Coatings</strong>, with over 32
                    years of experience and highly skilled professionals, can be the best choice throughout Sydney.
                    No matter what size or category project you want to coat, we are trained to turn your floor into
                    a masterpiece.
                  </p>

                  <p>
                    We are Dulux Accredited and a member of the Master Painters Association. We can give you the
                    customised colour and design option according to your preference. Our professional painters in
                    Sydney can also suggest you the best match for your space.
                  </p>

                  <p>
                    We provide high-quality{" "}
                    <strong>
                      <Link href="/epoxy-floor-coatings/">epoxy coating Sydney-wide</Link>
                    </strong>{" "}
                    with top-notch workmanship. We know the value of your time. That&rsquo;s why we get our service
                    done with minimal disruption. We also offer service after work.
                  </p>

                  <p>
                    Our license and insurance talk about our authenticity. Every tiny detail is a part of our focus.
                    We give on-time and budget-friendly service. We don&rsquo;t have any hidden costs. Our training
                    enables us to offer diverse services to meet all our client&rsquo;s requirements. We have
                    covered all the areas, from hospitals and garage floors to commercial and home kitchens, stores,
                    restaurants, shopping malls, and offices.
                  </p>

                  <p>
                    Our Sydney painters team is an expert in all aspects, whether it&rsquo;s about the preparation of
                    the surface, installation or removal of the floor coverings. We never compromise the quality of
                    our epoxy floor coatings materials; thus, our customers can get complete satisfaction and
                    long-lasting result.
                  </p>

                  <p>
                    You can also check our testimonial and recent work to know about our proficiency. We have a
                    strong and cooperative working relationship with our customers from the project beginning to the
                    handover of their desired floor. Even most of the time, our service exceeds their expectation.
                    You can call or mail us anytime if you want to know anything about us.
                  </p>
                </div>
                ...
                <div className="mt-10 flex items-center gap-3 border-t border-black/10 pt-8">
                  ...
                  <ShareIcon
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(POST_URL)}&text=${encodeURIComponent("Get Your Epoxy Flooring Done with Our Epoxy Floor Coating Experts in Sydney")}`}
                    label="Share on X"
                  >
                  ...
                  <ShareIcon
                    href={`mailto:?subject=${encodeURIComponent("Get Your Epoxy Flooring Done with Our Epoxy Floor Coating Experts in Sydney")}&body=${encodeURIComponent(`Check out this article: ${POST_URL}`)}`}
