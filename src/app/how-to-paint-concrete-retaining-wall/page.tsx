...
export default function ConcreteRetainingWallPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "How to Paint Concrete Retaining Wall", path: "/how-to-paint-concrete-retaining-wall/" }]} />
      <JsonLd data={articleSchema({
          headline: "How to Paint Concrete Retaining Wall",
          ...
          image: "/images/concrete-retaining-wall-blog-banner.jpg",
