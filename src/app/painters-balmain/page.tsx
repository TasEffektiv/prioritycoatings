...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Get professional painters in Balmain for all your painting needs of residential, commercial & strata projects. Quality painting & personalised service. Call NOW!",
