...
export default function SustainableCommercialPaintingPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Sustainable Commercial Painting Practices: Eco-Friendly Tips", path: "/sustainable-commercial-painting-eco-friendly-tips/" }]} />
      <JsonLd data={articleSchema({
          headline: "Sustainable Commercial Painting Practices: Eco-Friendly Tips",
          description: "Discover eco-friendly commercial painting practices — low VOC paints, waste reduction and durable coatings — to help Sydney businesses paint more sustainably.",
          path: "/sustainable-commercial-painting-eco-friendly-tips",
          image: "/images/sustainable-commercial-painting-chatgpt-image.jpg",
