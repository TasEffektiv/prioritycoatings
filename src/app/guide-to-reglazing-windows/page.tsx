...
export default function GuideToReglazingWindowsPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Guide to Reglazing Windows", path: "/guide-to-reglazing-windows/" }]} />
      <JsonLd data={articleSchema({
          headline: "Guide to Reglazing Windows",
          description: "A step-by-step guide to reglazing windows — the tools, materials and technique needed to repair cracked putty and restore a weather-tight seal.",
          path: "/guide-to-reglazing-windows",
          image: "/images/windows-of-house.jpg",
          datePublished: "August 7, 2025",
        })} />
      <main>
            ...
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <article className="lg:w-2/3">
                <h1 className="font-heading text-[32px] font-bold leading-[1.2] text-brand-navy sm:text-[40px]">
                  Guide to Reglazing Windows
                </h1>

                <p className="mt-4 text-[15px] text-black/60">August 7, 2025</p>
                ...
                <div className="prose-blog mt-8 max-w-none text-[16px] leading-[1.8] text-black/80">
                  <p>
                    Windows are more than a portal to admit light. Windows border our world view, cycle our rooms,
                    and protect us from elements. With the passage of time, even the best windows get their share of
                    wear and tear, particularly around the glazing. Ruptured or aged window putty is not just ugly;
                    it welcomes drafts, moisture, and rot. That&rsquo;s where reglazing becomes truly valuable.
                  </p>

                  <p>
                    When glazing putty cracks, peels, or crumbles, it indicates that your protective window shield is
                    compromised. Loose panes, condensation between the glass, or old, flaking putty are all signs of
                    needing to reglaze. This article will guide you through the entire process with clear, down-to-
                    earth instructions. Whether you&rsquo;re a seasoned DIY enthusiast or simply exploring your
                    options, you&rsquo;ll walk away knowing exactly what to expect.
                  </p>

                  <h3>What Is Window Reglazing and Why It Matters?</h3>

                  <p>
                    To put it simply, glazing is what keeps your window glass secure and sealed. It&rsquo;s a putty
                    compound applied around the edges of the pane to protect it from air and moisture. With time,
                    weathering and temperature fluctuations weaken the compound, making it shrink, crack, or even
                    fall off.
                  </p>

                  <p>
                    Reglazing entails stripping out the broken putty, prepping the surface, installing new compound,
                    and repainting it. It gives your window a new look again, recovers weather tightness, and can
                    reduce energy consumption drastically. Better yet, it can save you the high cost of window
                    replacement.
                  </p>

                  <h3>How to Know When Your Windows Need Reglazing</h3>

                  <p>
                    Some issues are hard to miss. If you run your fingers along the edge of the glass and feel gaps
                    or flaking, the glazing has likely failed. Rattling panes or water stains near the sashes are
                    also strong indicators. Peeling paint and persistent drafts are devious symptoms that
                    shouldn&rsquo;t be overlooked.
                  </p>

                  <p>
                    Even if the window appears to be structurally sound, low-quality glazing can compromise its
                    performance. Early repair of the problem prevents rot, mold, and water entry, especially in wood
                    frames.
                  </p>
                  ...
                  <p>
                    Jumping into a reglazing project unprepared can lead to frustration. The materials are affordable
                    and readily available at most hardware stores. Here&rsquo;s what you&rsquo;ll need:
                  </p>

                  <ul>
                    <li>A glazier&rsquo;s knife or putty knife</li>
                    <li>Safety gloves and eye protection</li>
                    <li>Heat gun or hair dryer (optional, for stubborn old putty)</li>
                    <li>Paint scraper or utility knife</li>
                    <li>Medium-to-fine grit sandpaper</li>
                    <li>Glazing compound (oil- or water-based)</li>
                    <li>Linseed oil (if using traditional oil-based putty)</li>
                    <li>Exterior-grade paint and brush</li>
                    <li>Small nails or glazier points (for wooden window frames)</li>
                  </ul>

                  <p>
                    When you start, double-check that the windowpane itself is acceptable. If cracked or broken,
                    replacement glass will also be needed.
                  </p>

                  <h3>Step-by-Step Instructions</h3>

                  <p>
                    You can follow these simple steps to have the desired result from the window reglazing process:
                  </p>

                  <h4>Step 1. Remove the Sash</h4>

                  <p>
                    On older wooden windows, you may be able to take the sash out completely. Doing so makes it
                    easier to access every corner and work at a comfortable angle.
                  </p>

                  <h4>Step 2. Remove the Old Glazing Compound</h4>

                  <p>
                    Wearing safety gloves, gently chip away the old putty with your glazier&rsquo;s knife. Use a heat
                    gun sparingly to soften stubborn areas. Be careful not to crack the glass or gouge the frame.
                  </p>

                  <h4>Step 3. Clean the Rabbet Thoroughly</h4>

                  <p>
                    Once the old material is gone, scrape off the residue and dust. For wooden frames, apply a light
                    coat of linseed oil&mdash;it helps the new putty adhere properly.
                  </p>

                  <h4>Step 4. Set the Glass (if needed)</h4>

                  <p>
                    If you&rsquo;ve removed or replaced the pane, make sure it fits snugly. Use glazier&rsquo;s
                    points or small nails to secure it gently without cracking it.
                  </p>

                  <h4>Step 5. Apply the Fresh Glazing Compound</h4>

                  <p>
                    Roll in palms to soften. Press on the edge, then smooth with your knife at a steady 45&deg;
                    angle. Try to achieve clean lines and a very shallow bevel to the edge.
                  </p>

                  <h4>Step 6. Allow Time to Cure</h4>

                  <p>
                    Give it time. Oil-based compound typically takes 7&ndash;14 days to skin over. Water-based
                    versions may cure in less than half that time. Only paint once it&rsquo;s dry to the touch.
                  </p>

                  <h4>Step 7. Paint for Protection</h4>

                  <p>
                    Finish with an exterior paint that overlaps the putty edge and a bit of the glass. This forms a
                    water-tight seal and prevents future cracking.
                  </p>

                  <h3>Tips to Avoid Common Mistakes</h3>

                  <p>
                    Even well-meaning DIYers make mistakes that cost time or lead to repeat work. Here&rsquo;s how to
                    stay on track:
                  </p>

                  <ul>
                    <li>Always remove old putty&mdash;never glaze over it.</li>
                    <li>Don&rsquo;t skip the linseed oil if using traditional compound.</li>
                    <li>Rushing the paint job? You&rsquo;ll regret it. Wait for full curing.</li>
                    <li>Sloppy angles or gaps will let moisture seep in.</li>
                  </ul>

                  <p>Precision now saves on repairs later. Measure twice, glaze once.</p>

                  <h3>How Long Will Reglazing Last?</h3>

                  <p>
                    Done right, window reglazing can hold strong for 15 to 30 years. Its life expectancy relies on
                    exposure to the outdoors, quality of materials, and proper maintenance.
                  </p>

                  <p>
                    Seal the cracks immediately, touch up paint if needed, and keep your sills clean. These small
                    things greatly contribute to the longevity of your work.
                  </p>

                  <h3>Wrap Up</h3>

                  <p>
                    With the proper gear and a little patience, reglazing can bring life to your windows, save you
                    money, make them more efficient, and get them looking nicer. If your panes are weeping, or your
                    putty is crumbling, it&rsquo;s time to get going. You can do it yourself or hire expert{" "}
                    <Link href="/residential-painters/">residential painters in Sydney</Link> like{" "}
                    <strong>Priority One Coatings</strong> to have a professional and long-lasting outcome.
                  </p>
                </div>
                ...
                <div className="mt-10 flex items-center gap-3 border-t border-black/10 pt-8">
                  ...
                  <ShareIcon
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(POST_URL)}&text=${encodeURIComponent("Guide to Reglazing Windows")}`}
                    label="Share on X"
                  >
                  ...
                  <ShareIcon
                    href={`mailto:?subject=${encodeURIComponent("Guide to Reglazing Windows")}&body=${encodeURIComponent(`Check out this article: ${POST_URL}`)}`}
