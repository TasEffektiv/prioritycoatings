...
export const metadata: Metadata = buildMetadata({
  ...
  description: "For renovation & painting your home or office, rely on qualified local painters in Alexandria. Get affordable & quality painting services in Alexandria. Contact now.",
  path: "/painters-alexandria/",
});
...
export default function PaintersAlexandriaPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Alexandria", path: "/painters-alexandria/" }]} />
      <JsonLd data={serviceSchema({
          name: "Painting Services in Alexandria",
          description:
            "Qualified local painters in Alexandria offering affordable & quality residential and commercial painting services.",
          path: "/painters-alexandria",
          areaServed: "Alexandria, NSW",
        })} />
      <main>
