...
export default function HowToRemoveWaterStainsFromWallsAndCeilingsPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "How to Remove Water Stains on Walls & Ceilings", path: "/how-to-remove-water-stains-from-walls-and-ceilings/" }]} />
      <JsonLd data={articleSchema({
          headline: "How to Remove Water Stains on Walls & Ceilings",
          description: "Water stains on walls and ceilings are a common Sydney home problem. Learn what causes them, how to remove them safely, and how to stop them from returning.",
          path: "/how-to-remove-water-stains-from-walls-and-ceilings",
          image: "/images/water-stain-on-walls-and-ceilings.png",
