...
export const metadata: Metadata = buildMetadata({
  ...
  description: "When painting your home, strata property or office building, you want to ensure the job is done perfectly. Need painters in Sydney? Priority One Coatings Can Help.",
...
export default function NeedPaintersSydneyPriorityOneCoatingsCanHelpPage() {
  return (
    <div id="top">
      <Header />
            ...
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <article className="lg:w-2/3">
                <h1 className="font-heading text-[32px] font-bold leading-[1.2] text-brand-navy sm:text-[40px]">
                  Need Painters in Sydney? Priority One Coatings Can Help
                </h1>

                <p className="mt-4 text-[15px] text-black/60">February 7, 2023</p>
                ...
                <div className="prose-blog mt-8 max-w-none text-[16px] leading-[1.8] text-black/80">
                  ...
                  <p>
                    When painting your home, strata property or office building, you want to ensure the job is
                    done perfectly. That&rsquo;s why choosing the right painting company for your project is so
                    important. And when it comes to hiring professional painters in Sydney, there&rsquo;s no better
                    choice than Priority One Coatings.
                  </p>

                  <p>
                    As one of the leading painting contractors in Sydney, we provide various services, including{" "}
                    <Link href="/commercial-painting/">commercial</Link>,{" "}
                    <Link href="/residential-painters/">residential</Link> and{" "}
                    <Link href="/strata-painters-sydney/">strata painting</Link>,{" "}
                    <Link href="/commercial-fitouts/">office fit-outs</Link>,{" "}
                    <Link href="/lead-paint-removal/">lead paint removal</Link> and{" "}
                    <Link href="/epoxy-floor-coatings/">epoxy floor coatings</Link>.
                  </p>

                  <p className="font-bold text-black">
                    Our accredited painters have more than 32 years of experience in the industry and have
                    undertaken a wide variety of big and small projects.
                  </p>

                  <p>
                    Whether you want to refresh the look of your home or embark on a significant renovation
                    project, we have the skills and experience to provide you with the best services. Our team
                    ensures a quality outcome that exceeds your expectations, and our commitment to client
                    satisfaction is our priority.
                  </p>

                  <p>
                    One thing distinguishing us from other Sydney painters is our attention to detail. We
                    understand that every painting project is unique, so we perform with you every step, from the
                    initial consultation to the final inspection. Our team will help you choose the right colours,
                    prepare the surfaces correctly, and pay attention to every detail to make sure your vision
                    becomes a reality.
                  </p>

                  <p>
                    As we only use the best quality paint products available, you can rest assured that our fresh
                    coat of paint will last longer. Also, our painters are equipped with the latest tools and
                    techniques. We work efficiently and transparently to confirm your project meets the deadline
                    and is within your preferred budget. At Priority One Coatings, we believe that communication is
                    vital. That&rsquo;s why we keep you informed at every step of our working process.
                  </p>

                  <p>
                    So, if you require painters in Sydney, look no further than Priority One Coatings. Our team of
                    qualified professionals is ready to deliver customer satisfaction, and we guarantee
                    you&rsquo;ll be impressed with the results. We invite you to scroll through our website and get
                    to know us better by checking out our <Link href="/portfolio/">portfolio</Link>, service
                    offerings, <Link href="/testimonials/">testimonials</Link>, and a gallery of our recent
                    projects. Reach us today to schedule your consultation and start your painting project!
                  </p>

                  <p className="font-bold text-black">
                    Contact us via telephone at <a href="tel:+61298085900">02 9808 5900</a> or by email at{" "}
                  ...
                  <div className="mt-10 rounded-md border-l-4 border-brand-teal bg-[#f3fafb] px-7 py-6">
                    <h3 className="mt-0">Ready to Start Your Painting Project?</h3>
                    <p>
                      Whether it&rsquo;s a home, office or strata property, our team will give you a clear, honest
                      scope and quote from the very first consultation.
                    </p>
                    <p className="mb-0">
                ...
                <div className="mt-10 flex items-center gap-3 border-t border-black/10 pt-8">
                  ...
                  <ShareIcon
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(POST_URL)}&text=${encodeURIComponent("Need Painters in Sydney? Priority One Coatings Can Help")}`}
                    label="Share on X"
                  >
                  ...
                  <ShareIcon
                    href={`mailto:?subject=${encodeURIComponent("Need Painters in Sydney? Priority One Coatings Can Help")}&body=${encodeURIComponent(`Check out this article: ${POST_URL}`)}`}
