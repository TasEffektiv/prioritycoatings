...
export default function TipsForPaintingYourCeilingsPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Tips for Painting Your Ceilings", path: "/tips-for-painting-your-ceilings/" }]} />
      <JsonLd data={articleSchema({
          headline: "Tips for Painting Your Ceilings",
          ...
          image: "/images/how-to-paint-ceilings-blog-banner.jpg",
