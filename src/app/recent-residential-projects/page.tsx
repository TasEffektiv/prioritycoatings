...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Priority One Coatings works for any big or small residential painting projects in Sydney. Check out what we have done for our clients.",
  path: "/recent-residential-projects/",
});
