...
export default function BuildingsStuccoPaintingRepairingPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Buildings Stucco Painting & Repairing", path: "/buildings-stucco-painting-repairing/" }]} />
      <JsonLd data={articleSchema({
          headline: "Buildings Stucco Painting & Repairing",
          ...
          image: "/images/residential-apartment-and-flat-building-exterior.jpg",
          datePublished: "June 4, 2025",
        })} />
      <main>
