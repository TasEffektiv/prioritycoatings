...
const RECENT_POSTS = POSTS.slice(1, 6);
          ...
          <div className="mx-auto max-w-[1430px] px-[15px]">
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <div className="lg:w-2/3">
                <div className="grid grid-cols-1 gap-x-[25px] sm:grid-cols-2">
                  {POSTS.map((post) => (
                ...
                <nav className="flex flex-wrap items-center justify-center gap-1 py-[30px] text-[15px] font-medium">
                  <span className="px-[18px] py-1 font-bold text-[#0052cc]">1</span>
                  <Link href="#" className="px-[18px] py-1 text-black transition-colors hover:text-brand-teal">
                    2
                  </Link>
                  <Link href="#" className="px-[18px] py-1 text-black transition-colors hover:text-brand-teal">
                    3
                  </Link>
                  <span className="px-1 text-brand-grey">&hellip;</span>
                  <Link href="#" className="px-[18px] py-1 text-black transition-colors hover:text-brand-teal">
                    18
                  </Link>
                  <Link
              ...
              <aside className="flex flex-col lg:w-1/3">
                <div className="mb-[50px] bg-white px-[30px] py-[50px] pb-[70px] text-center">
                  <svg
                    className="mx-auto"
                    width="90"
                    height="91"
                  ...
                  <p className="mt-2 text-black/70">
                    Experience a vibrant new look for your home or business. Book your free consultation
                    today.
                  </p>
                  <Link
                    href="/contact-us/"
                ...
                <div className="mb-[25px] bg-white p-[50px]">
                  <Link
                    href={FEATURED_POST.href}
                    className="group relative block h-[188px] w-full overflow-hidden"
                  >
                    <Image
                  ...
                  <div className="pt-5">
                    <h4 className="text-[23px] font-bold leading-[31px] text-black">
                      <Link href={FEATURED_POST.href} className="hover:text-brand-teal">
                        {FEATURED_POST.title}
                      </Link>
                    </h4>
                    <p className="mt-4 text-[15px] text-black/70">{FEATURED_POST.date}</p>
                  </div>
                </div>
