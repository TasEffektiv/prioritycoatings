...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting",
  },
};

export default function ResidentialPaintingCategoryPage() {
  ...
  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
