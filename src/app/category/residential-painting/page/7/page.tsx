...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 7 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/7",
  },
};

export default function ResidentialPaintingCategoryPageSeven() {
  const { items, totalPages } = paginate(categoryPosts, 7);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/7" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
