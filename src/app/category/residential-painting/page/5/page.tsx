...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 5 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/5",
  },
};

export default function ResidentialPaintingCategoryPageFive() {
  ...
  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/5" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
