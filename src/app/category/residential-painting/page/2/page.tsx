...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 2 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/2",
  },
};

export default function ResidentialPaintingCategoryPageTwo() {
  ...
  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/2" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
