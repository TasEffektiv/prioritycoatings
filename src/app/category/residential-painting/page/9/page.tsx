...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 9 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/9",
  },
};

export default function ResidentialPaintingCategoryPageNine() {
  const { items, totalPages } = paginate(categoryPosts, 9);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/9" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
