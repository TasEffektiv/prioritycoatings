...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 10 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/10",
  },
};

export default function ResidentialPaintingCategoryPageTen() {
  const { items, totalPages } = paginate(categoryPosts, 10);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/10" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
