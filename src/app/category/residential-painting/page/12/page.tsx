...
export const metadata: Metadata = buildMetadata({
  title: "Residential Painting | Blog | Page 12 | Priority One Coatings",
  ...
  path: "/category/residential-painting/page/12/",
});

export default function ResidentialPaintingCategoryPageTwelve() {
  const { items, totalPages } = paginate(categoryPosts, 12);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/12" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
