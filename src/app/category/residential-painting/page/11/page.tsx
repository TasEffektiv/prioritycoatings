...
export const metadata: Metadata = {
  title: "Residential Painting | Blog | Page 11 | Priority One Coatings",
  description:
  ...
  alternates: {
    canonical: "/category/residential-painting/page/11",
  },
};

export default function ResidentialPaintingCategoryPageEleven() {
  const { items, totalPages } = paginate(categoryPosts, 11);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/11" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
