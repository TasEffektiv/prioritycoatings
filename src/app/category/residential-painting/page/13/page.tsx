...
export const metadata: Metadata = buildMetadata({
  title: "Residential Painting | Blog | Page 13 | Priority One Coatings",
  ...
  path: "/category/residential-painting/page/13/",
});

export default function ResidentialPaintingCategoryPageThirteen() {
  const { items, totalPages } = paginate(categoryPosts, 13);

  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/residential-painting/page/13" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
