...
export default function DiyCategoryPageFive() {
  ...
  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/diy/page/5" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
          ...
          <div className="mx-auto max-w-[1430px] px-[15px]">
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <div className="lg:w-2/3">
                ...
                <BlogPagination currentPage={5} totalPages={totalPages} basePath="/category/diy" />
              </div>
