...
export const metadata: Metadata = buildMetadata({
  title: "News | Blog | Page 2 | Priority One Coatings",
...
export default function NewsCategoryPageTwo() {
  ...
  return (
    <div id="top">
      <Header />
      <main>
        <PageHeader path="/category/news/page/2" title={CATEGORY} parent={{ label: "Blog", href: "/blog/" }} />
