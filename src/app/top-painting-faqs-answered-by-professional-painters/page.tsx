...
export default function TopPaintingFaqsPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Top Painting FAQs Answered by Professional Painters", path: "/top-painting-faqs-answered-by-professional-painters/" }]} />
      <JsonLd data={articleSchema({
          headline: "Top Painting FAQs Answered by Professional Painters",
          description: "Clear answers to the most common painting questions — cost, timelines, paint types, warranties and more — from Sydney's Priority One Coatings.",
          path: "/top-painting-faqs-answered-by-professional-painters",
          image: "/images/common-faqs-blog-banner.jpg",
