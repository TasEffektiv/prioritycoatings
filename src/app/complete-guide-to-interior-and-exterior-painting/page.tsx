...
export default function CompleteGuideInteriorExteriorPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Complete Guide to Interior and Exterior Painting", path: "/complete-guide-to-interior-and-exterior-painting/" }]} />
      <JsonLd data={articleSchema({
          headline: "Complete Guide to Interior and Exterior Painting",
          description: "Everything you need to know about interior and exterior painting — benefits, key differences, preparation, techniques and FAQs — from Priority One Coatings.",
          path: "/complete-guide-to-interior-and-exterior-painting",
          image: "/images/residential-houses-at-battery-point-in-hobart-australia.jpg",
          datePublished: "January 10, 2026",
        })} />
      <main>
