...
export default function EfflorescenceInMasonryPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Efflorescence in Masonry", path: "/efflorescence-in-masonry/" }]} />
      <JsonLd data={articleSchema({
          headline: "Efflorescence in Masonry",
          ...
          image: "/images/white-texture-brick-wall.jpg",
          ...
          <div className="mx-auto max-w-[1430px] px-[15px]">
            ...
            <div className="flex flex-col gap-[25px] lg:flex-row">
              <article className="lg:w-2/3">
                ...
                <p className="mt-4 text-[15px] text-black/60">April 28, 2025</p>
                ...
                <div className="prose-blog mt-8 max-w-none text-[16px] leading-[1.8] text-black/80">
                  <p>
                    Have you ever found chalky patches on the masonry surface of your home? It&rsquo;s most probably
                    a sign of efflorescence. So, what is efflorescence?
                  </p>

                  <p>
                    The surface of masonry (concrete, render, brick, or mortar) that has crusty white mineral salts
                    that have leached out from within the substrate when moisture migrates through it is commonly
                    referred to as efflorescence. Calcium carbonate makes up the majority of efflorescence, which is
                    visible as white alkaline salts on the surface of masonry. It requires a fair amount of moisture
                    in order to form.
                  </p>

                  <p>Efflorescence may happen at various times.</p>

                  <ul>
                    <li>
                      <strong>Primary efflorescence:</strong> When there is too much moisture in the building
                      materials, primary efflorescence, also known as &ldquo;new building bloom&rdquo;, may show up
                      within the first 72 hours.
                    </li>
                    <li>
                      <strong>Secondary efflorescence:</strong> Salts are extracted to the surface of the building
                      materials by water penetration and external moisture problems, which results in secondary
                      efflorescence.
                    </li>
                  </ul>

                  <h3>Is efflorescence a serious problem?</h3>

                  <p>
                    Efflorescence by itself is not harmful, but it may indicate a more significant issue for your
                    property&rsquo;s foundation. Water seeping into your foundation and bringing these salts to the
                    surface is marked by efflorescence. Over time, your foundation may sustain damage if this water
                    intrusion is not addressed.
                  </p>

                  <p>
                    The concrete or masonry on your foundation may deteriorate due to the salts that have been
                    deposited on its surface, resulting in cracking and other structural damage.
                  </p>

                  <h3>What are the leading causes of efflorescence?</h3>

                  <p>
                    The mechanisms underlying efflorescence are numerous and complex. In a nutshell, efflorescence
                    happens when water with dissolved salts is brought to the masonry&rsquo;s surface, where the
                    salts remain after the water evaporates.
                  </p>

                  <p>
                    Well, there is a common assumption that the problem appears because of the surface material,
                    specifically brick. The soluble compounds are typically visible on brick due to their darker
                    colour, and brick tends to transport water due to its capillary porous nature. So, in simple
                    words, it is incorrect to assume that brick causes efflorescence.
                  </p>

                  <p>Let&rsquo;s look at some of the actual reasons behind it.</p>

                  <ul>
                    <li>
                      The brickwork must contain or come into contact with soluble salts. Brick, mortar ingredients,
                      backing materials, trim, or nearby soil may contain these salts.
                    </li>
                    <li>The salts must come into contact with a water source long enough to dissolve them.</li>
                    <li>
                      The masonry needs to have a pore structure that permits salt solutions to migrate to the
                      surface or other areas where water evaporation can take place.
                    </li>
                  </ul>

                  <h3>What is the best treatment for removing efflorescence?</h3>

                  <p>
                    Are you a homeowner in Sydney and wondering how to get rid of this? Fortunately, there are a few
                    methods and home remedies for removing efflorescence that you can try-
                  </p>

                  <ul>
                    <li>
                      <strong>Diluted vinegar:</strong> White vinegar that has been diluted at home can be applied to
                      efflorescence in an emergency. You probably already have vinegar in your kitchen, and
                      it&rsquo;s less harmful than industrial chemicals.
                    </li>
                    <li>
                      <strong>Brushing:</strong> You can easily remove efflorescence with a powerful brush. Be sure
                      to finish this task in dry, warm weather. Since moisture can cause additional salts to
                      accumulate on the brick&rsquo;s surface, dry brushing can be used to get rid of them.
                    </li>
                    <li>
                      <strong>Pressurised water:</strong> Using pressurised water could rapidly eliminate
                      efflorescence. A professional painter in Sydney will advise drying off any water you may have
                      used before starting the painting procedure. If the water is not removed, crystals might still
                      be present, which could lead to the reappearance of efflorescence.
                    </li>
                  </ul>

                  <h3>How to stop efflorescence in masonry?</h3>

                  <p>
                    It&rsquo;s always best to take preventive steps if you want to keep your property well-maintained.
                    So, we have come up with an answer to the question of how to prevent efflorescence in masonry-
                  </p>

                  <ul>
                    <li>
                      Soluble salts are carried to the surface of the masonry by water, so take steps like installing
                      proper moisture barriers to prevent any masonry walling from absorbing moisture.
                    </li>
                    <li>After the concrete has been poured, properly cure it to help stop salt efflorescence from forming.</li>
                    <li>Avoid placing bricks directly on the ground to keep water from seeping into the materials.</li>
                    <li>Make sure the non-porous masonry products you choose have low levels of salt and calcium.</li>
                    <li>
                      Choose design details of the architecture where water collection is directed away from
                      horizontal surfaces and wall tops.
                    </li>
                    <li>
                      Get wide overhanging roofs, if possible from an architectural standpoint, to help shield walls
                      from rainfall.
                    </li>
                    <li>
                      For the first week after construction, freshly laid brickwork should be protected from the
                      weather to avoid salt efflorescence.
                    </li>
                  </ul>

                  <h3>Need help with your masonry surface?</h3>

                  <p>
                    Efflorescence usually shows up before painting a masonry surface. So, you must be wondering if
                    you can paint over efflorescence. Yes, but before painting, it is essential to remove it first
                    as it might prevent the proper adhesion of paint.
                  </p>

                  <p>
                    So, to solve all these issues and ensure flawless masonry, contact{" "}
                    <strong>Priority One Coatings</strong>. Along with providing the best painting services in
                    Sydney, our <Link href="/residential-painters/">professional residential painters</Link> make
                    sure to clean the surface, repair any kind of damage and prepare a smooth base for a
                    long-lasting result.
                  </p>

                  <p className="text-center font-bold text-brand-navy">Request a quote or call us today.</p>
                </div>
                ...
                <div className="mt-10 flex items-center gap-3 border-t border-black/10 pt-8">
                  ...
                  <ShareIcon
                    href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(POST_URL)}&text=${encodeURIComponent("Efflorescence in Masonry")}`}
                    label="Share on X"
                  >
                  ...
                  <ShareIcon
                    href={`mailto:?subject=${encodeURIComponent("Efflorescence in Masonry")}&body=${encodeURIComponent(`Check out this article: ${POST_URL}`)}`}
