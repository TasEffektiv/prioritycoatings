...
export default function WhyStainResistantPaintPage() {
  return (
    <div id="top">
      <Header />
      <Breadcrumb items={[{ label: "Blog", path: "/blog/" }, { label: "Why Do You Need Stain-Resistant Paints?", path: "/why-stain-resistant-paint/" }]} />
      <JsonLd data={articleSchema({
          headline: "Why Do You Need Stain-Resistant Paints?",
          ...
          image: "/images/stain-resistant-paint-scaled.jpg",
